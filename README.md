...
1.  **원클릭 PDF 생성**: 스프레드시트 메뉴에서 견적서를 바로 생성합니다.
2.  **스마트 데이터 처리**:
...
3.  상단 메뉴에서 `견적서` > `선택 견적번호로 PDF 생성`을 클릭합니다.
4.  잠시 후 "PDF 링크" 모달이 뜨면 링크를 클릭하여 확인합니다.
